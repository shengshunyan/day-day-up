...
date: 2020-06-03
keywords: restful, api, 后端
cover: https://s1.ax1x.com/2020/06/03/tUr68f.jpg
tags:
     - JavaScript
---
...
在RESTful架构中，每个网址代表一种资源（resource），所以 **网址中不能有动词，只能有名词** ，而且所用的名词往往与数据库的表格名对应。一般来说，数据库中的表都是同种记录的"集合"（collection），所以 **API中的名词也应该使用复数** 。
